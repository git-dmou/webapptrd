...
public abstract class UploadFormPanelArchiveV6 extends Panel {
     ...
     */
    public UploadFormPanelArchiveV6(String id, IModel<File> model, final boolean displayMaxFileSize) {
        super(id, model);
        initPanel(model,
                new StringResourceModel("defaultButtonLabel", this, null),
                new StringResourceModel("progressLabel", this, null),
                displayMaxFileSize
        );
    }
     ...
     * @param loadingLabel          Le label à présenter pendant le traitement de l'upload
     * @param displayMaxFileSize    Doit-on afficher la taille maximale permise des fichiers ?
     */
    public UploadFormPanelArchiveV6(String id, IModel<File> model, IModel<String> buttonLabel, IModel<String> loadingLabel,
    ...
    private void initPanel(IModel<File> model, IModel<String> buttonLabel, IModel<String> loadingLabel,
        ...
        // L'upload de fichier
        form = new UploadFormPanelArchiveV6.FileUploadForm("uploadForm", model);
        add(form);
        ...
        add(new Image("illustrationPersonnalisation", new PackageResourceReference(UploadFormPanelArchiveV6.class,
                "../img" + "/illustrationPersonnalisation.svg")));
    }
        ...
        public FileUploadForm(String id, IModel<File> model) {
            ...
            AjaxFormSubmitBehavior behavior = new AjaxFormSubmitBehavior(this, "onchange") {
                protected void onSubmit(AjaxRequestTarget target) {
                    ...
                    // et enregistré.
                    UploadFormPanelArchiveV6.FileUploadForm.this.onUploaded(target);
                }
            };
        ...
        public void onUploaded(AjaxRequestTarget target) {
            ...
            if (uploads != null) {
                for (FileUpload upload : uploads) {
                    ...
                    onUpload((File) UploadFormPanelArchiveV6.this.getDefaultModelObject(), filename, target);
