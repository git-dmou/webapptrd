...
public abstract class UploadFormPanelWithLangOnly extends Panel {

    protected static final Logger logger = Logger.getLogger(UploadFormPanelWithLangOnly.class);
     ...
     */
    public UploadFormPanelWithLangOnly(String id, IModel<File> model, final boolean displayMaxFileSize,
     ...
     * @param displayMaxFileSize Doit-on afficher la taille maximale permise des fichiers ?
     */
    public UploadFormPanelWithLangOnly(String id, IModel<File> model, IModel<String> buttonLabel, final boolean displayMaxFileSize, IModel<Locale> selectedLocaleModel) {
        super(id, model);
            ...
            if (uploads != null) {
                for (FileUpload upload : uploads) {
                    ...
                    try {
                        ...
                        // réussite d'upload");
                        StringResourceModel confirmMessageModel = new StringResourceModel("upload.confirm", this, null, new Object[]{upload.getClientFileName()});
                        ...
                        StringResourceModel errorMessageModel = new StringResourceModel("upload.error", this, null, new Object[]{upload.getClientFileName()});
                    ...
                    onUpload((File) UploadFormPanelWithLangOnly.this.getDefaultModelObject(), filename, target);
